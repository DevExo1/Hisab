/**
 * Activity Screen
 * Recent activity with lazy loading and compact design
 */
...
export default function ActivityScreen() {
  ...
  const onEndReached = async () => {
    if (loadingMore || !activityMetadata.hasMore) return;
  ...
  const renderEmpty = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={[styles.emptyText, { color: theme.text }]}>No activity yet</Text>
